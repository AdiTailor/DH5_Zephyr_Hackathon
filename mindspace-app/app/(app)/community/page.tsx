          ...
          <div className="mb-12 max-w-6xl mx-auto">
            <div className="bg-white/70 backdrop-blur-sm border border-white/20 rounded-3xl shadow-xl p-8 hover:shadow-2xl transition-all duration-500 animate-slide-up">
              <div className="flex items-center gap-4 mb-6">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-slate-800">Share Your Thoughts</h3>
                  <p className="text-slate-600 text-sm">Your story might be exactly what someone needs to hear</p>
                </div>
              </div>
